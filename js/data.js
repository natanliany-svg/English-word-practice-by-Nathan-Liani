...
window.week16ArticleData = [
    { j:"??", e: "CPR in Adults and Children and Treatment of Choking", h: "החייאה במבוגרים ובילדים וטיפול בחנק", isHeader: true },
    { j:"1", e: "Every year, thousands of lives are saved because ordinary people know how to perform cardiopulmonary resuscitation (CPR) and how to help someone who is choking.", h: "מדי שנה, אלפי חיים ניצלים כי אנשים רגילים יודעים כיצד לבצע החייאה לבבית-ריאתית (CPR) וכיצד לעזור למישהו שנחנק.", isHeader: false },
    { j:"2", e: "Cardiac arrest can happen suddenly to adults or children, and without immediate action, the brain begins to suffer permanent damage within only a few minutes.", h: "דום לב יכול לקרות לפתע למבוגרים או לילדים, וללא פעולה מיידית, המוח מתחיל לסבול מנזק תמידי תוך דקות ספורות.", isHeader: false },
    { j:"3", e: "Learning the basic principles of CPR and choking treatment allows bystanders to provide lifesaving assistance until professional medical personnel arrive.", h: "למידת העקרונות הבסיסיים של החייאה וטיפול בחנק מאפשרת לעוברי אורח לספק סיוע מציל חיים עד להגעת צוות רפואי מקצועי.", isHeader: false },
    { j:"??", e: "What Is CPR?", h: "מהי החייאה?", isHeader: true },
    ...
    { j:"5", e: "The goal of CPR is to maintain blood circulation and deliver oxygen to vital organs, especially the brain and heart, until advanced medical treatment becomes available.", h: "מטרת ההחייאה היא לשמור על מחזור הדם ולספק חמצן לאיברים חיוניים, במיוחד למוח וללב, עד שטיפול רפואי מתקדם יהיה זמין.", isHeader: false },
    { j:"6", e: "Modern CPR combines two essential actions: Chest compressions to keep blood circulating, and Rescue breaths, when appropriate, to provide oxygen.", h: "החייאה מודרנית משלבת שתי פעולות חיוניות: לחיצות חזה כדי לשמור על זרימת הדם, והנשמות, כאשר מתאים, כדי לספק חמצן.", isHeader: false },
    { j:"7", e: "Studies have shown that immediate CPR can significantly increase a person's chance of survival after cardiac arrest.", h: "מחקרים הראו שהחייאה מיידית יכולה להגדיל משמעותית את סיכויי ההישרדות של אדם לאחר דום לב.", isHeader: false },
    { j:"??", e: "CPR for Adults", h: "החייאה למבוגרים", isHeader: true },
    { j:"8", e: "Before beginning CPR, the rescuer should first ensure that the scene is safe.", h: "לפני תחילת ההחייאה, על המציל לוודא תחילה שהזירה בטוחה.", isHeader: false },
    { j:"9", e: "The next step is to check whether the person responds by speaking loudly and gently tapping the shoulders.", h: "השלב הבא הוא לבדוק האם האדם מגיב על ידי דיבור בקול רם וטפיחה קלה על הכתפיים.", isHeader: false },
    { j:"10", e: "If there is no response and the person is not breathing normally, emergency medical services should be called immediately.", h: "אם אין תגובה והאדם אינו נושם כרגיל, יש להזעיק מיד את שירותי רפואת החירום.", isHeader: false },
    { j:"11", e: "Chest compressions are performed by placing both hands in the center of the chest.", h: "לחיצות חזה מתבצעות על ידי הנחת שתי הידיים במרכז החזה.", isHeader: false },
    { j:"12", e: "The rescuer should push hard and fast at a rate of about 100-120 compressions per minute, allowing the chest to return to its normal position after each compression.", h: "על המציל לדחוף חזק ומהר בקצב של כ-100 עד 120 לחיצות בדקה, ולתת לחזה לחזור למצבו הרגיל לאחר כל לחיצה.", isHeader: false },
    { j:"13", e: "The recommended compression depth for adults is approximately 5-6 centimeters.", h: "עומק הלחיצה המומלץ למבוגרים הוא כ-5 עד 6 סנטימטרים.", isHeader: false },
    { j:"14", e: "If the rescuer is trained and willing, rescue breaths may be given after every 30 chest compressions, using a ratio of 30 compressions followed by 2 breaths.", h: "אם המציל מיומן ומוכן לכך, ניתן לתת הנשמות לאחר כל 30 לחיצות חזה, תוך שימוש ביחס של 30 לחיצות ואחריהן 2 הנשמות.", isHeader: false },
    { j:"15", e: "CPR should continue until professional help arrives or the person begins to breathe normally.", h: "יש להמשיך בהחייאה עד שהעזרה המקצועית מגיעה או עד שהאדם מתחיל לנשום כרגיל.", isHeader: false },
    { j:"??", e: "CPR for Children", h: "החייאה לילדים", isHeader: true },
    ...
    { j:"17", e: "Chest compressions should be performed at the same rate of 100-120 compressions per minute, but the compression depth should be about one-third of the chest's depth.", h: "יש לבצע לחיצות חזה באותו קצב של 100-120 לחיצות בדקה, אך עומק הלחיצה צריך להיות כשליש מעומק החזה.", isHeader: false },
    { j:"18", e: "For most children, one or two hands may be used depending on the child's size and the rescuer's strength.", h: "עבור רוב הילדים, ניתן להשתמש ביד אחת או שתיים בהתאם לגודל הילד ולחוזקו של המציל.", isHeader: false },
    { j:"19", e: "Because breathing problems are more common in children, rescue breaths are especially important when the rescuer has received CPR training.", h: "מכיוון שבעיות נשימה שכיחות יותר אצל ילדים, הנשמות חשובות במיוחד כאשר המציל עבר הכשרת החייאה.", isHeader: false },
    { j:"??", e: "Choking Caused by a Foreign Object", h: "חנק כתוצאה מעצם זר", isHeader: true },
    { j:"20", e: "Choking occurs when food or another object blocks the airway, preventing air from reaching the lungs.", h: "חנק מתרחש כאשר אוכל או חפץ אחר חוסם את נתיב האוויר, ומונע מאוויר להגיע לריאות.", isHeader: false },
    { j:"21", e: "A person who is choking may suddenly be unable to speak, cough, or breathe.", h: "אדם שנחנק עשוי לפתע לא להיות מסוגל לדבר, להשתעל או לנשום.", isHeader: false },
    { j:"22", e: "They may hold their throat with both hands, a well-known sign called the universal choking sign.", h: "הם עשויים להחזיק את גרונם בשתי ידיהם, סימן מוכר הנקרא סימן החנק האוניברסלי.", isHeader: false },
    { j:"23", e: "If the person can cough forcefully, they should be encouraged to continue coughing, as this is often the best way to remove the obstruction.", h: "אם האדם מסוגל להשתעל בחוזקה, יש לעודד אותו להמשיך להשתעל, שכן זו לרוב הדרך הטובה ביותר להסיר את החסימה.", isHeader: false },
    { j:"24", e: "If the airway becomes completely blocked and the person cannot breathe or speak, immediate action is required.", h: "אם נתיב האוויר נחסם לחלוטין והאדם אינו יכול לנשום או לדבר, נדרשת פעולה מיידית.", isHeader: false },
    { j:"25", e: "For adults and children over one year of age, the recommended treatment is a series of firm back blows followed, if necessary, by abdominal thrusts.", h: "למבוגרים ולילדים מעל גיל שנה, הטיפול המומלץ הוא סדרה של טפיחות חזקות על הגב ואחריהן, במידת הצורך, לחיצות בטן.", isHeader: false },
    { j:"26", e: "These actions help create pressure inside the airway that may force the object out.", h: "פעולות אלו עוזרות ליצור לחץ בתוך נתיב האוויר שעשוי לדחוף את החפץ החוצה.", isHeader: false },
    { j:"27", e: "For infants under one year of age, abdominal thrusts must not be used because they may cause serious injury.", h: "עבור תינוקות מתחת לגיל שנה, אסור להשתמש בלחיצות בטן מכיוון שהן עלולות לגרום לפציעה חמורה.", isHeader: false },
    { j:"28", e: "Instead, rescuers alternate between back blows and chest thrusts until the object is removed or the infant becomes unresponsive.", h: "במקום זאת, מצילים מחליפים בין טפיחות גב ולחיצות חזה עד שהחפץ מוסר או עד שהתינוק מאבד את הכרתו.", isHeader: false },
    { j:"??", e: "When Choking Leads to Unconsciousness", h: "כאשר חנק מוביל לחוסר הכרה", isHeader: true },
    { j:"29", e: "If a choking victim becomes unconscious, emergency medical services should be contacted immediately.", h: "אם קורבן חנק מאבד את הכרתו, יש ליצור קשר עם שירותי רפואת החירום באופן מיידי.", isHeader: false },
    { j:"30", e: "CPR should then be started without delay.", h: "לאחר מכן יש להתחיל בהחייאה ללא דיחוי.", isHeader: false },
    ...
    { j:"??", e: "The Importance of Training", h: "החשיבות של הכשרה", isHeader: true },
    { j:"32", e: "Although reading about CPR and choking treatment provides useful knowledge, practical training is essential.", h: "למרות שקריאה על החייאה וטיפול בחנק מספקת ידע שימושי, הכשרה מעשית היא חיונית.", isHeader: false },
    { j:"33", e: "CPR courses allow participants to practice chest compressions, rescue breaths, and choking techniques using realistic training mannequins.", h: "קורסי החייאה מאפשרים למשתתפים לתרגל לחיצות חזה, הנשמות וטכניקות חנק באמצעות בובות אימון מציאותיות.", isHeader: false },
    { j:"34", e: "Medical organizations around the world recommend regular refresher training because guidelines may change as new scientific evidence becomes available.", h: "ארגוני רפואה ברחבי העולם ממליצים על רענון הכשרה קבוע מכיוון שההנחיות עשויות להשתנות ככל שראיות מדעיות חדשות זמינות.", isHeader: false },
    { j:"35", e: "Knowing how to recognize cardiac arrest, perform CPR, and respond to choking can make the difference between life and death.", h: "לדעת כיצד לזהות דום לב, לבצע החייאה ולהגיב לחנק יכולה לעשות את ההבדל בין חיים למוות.", isHeader: false },
    { j:"36", e: "Even simple actions taken by a bystander during the first few minutes of an emergency can greatly improve the chances of survival until professional medical help arrives.", h: "אפילו פעולות פשוטות שננקטות על ידי עובר אורח במהלך הדקות הראשונות של מקרה חירום יכולות לשפר מאוד את סיכויי ההישרדות עד שהעזרה הרפואית המקצועית תגיע.", isHeader: false }
];
